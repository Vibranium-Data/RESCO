...
We then generate an power restoration duration Indicator based on two Measurements: power fault time and power restoration time. Each Measurement can be generated by its associated power disruption and power restoration Events.
